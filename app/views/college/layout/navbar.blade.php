...
{
    display:inline-block; padding-top:35px; padding-bottom:10px; width:200px;
}
...
<div class="header-main col-lg-12 col-sm-12 col-md-12">
    <div class="container">
        <div class="logo-area">
            <a href="<?php echo URL::to('/college'); ?>"><img src="<?php echo URL::to('/'); ?>/public/img/logo.png" height="70px" width="100px"></a>
        </div>
        <div class="logo-area">
            <a  href="<?php echo URL::to('/college'); ?>"><img src="<?php echo URL::to('/'); ?>/public/img/header logo.png" height="120px" width="300px"></a>
        </div>
        <div class="navs-area">
                 @if(Auth::check())
                <ul class="logged">
                        <li>
                    <a href="<?php echo URL::to('/college/question/create-text') ?>" ><strong>AddQuestions</strong></a>
                </li>
                <li><a href="<?php echo URL::to('/college/question/view') ?>"><strong>ViewQuestion</strong></a></li>
                <li><a href="<?php echo URL::to('/college/score/view') ?>"><strong>Score</strong></a></li>
                <li class="last">
                ...
                <li class="last"><a href="<?php echo URL::to('/account/create') ?>">Register</strong></a></li>
                </ul>
                @endif
