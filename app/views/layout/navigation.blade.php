...
<div class="header-main">
    <div class="container">
        <div class="logo-area">
            <a href="<?php echo URL::to('/'); ?>"><img src="/public/img/logo.png" height="70px" width="100px"></a>
        </div>
        <div class="logo-area">
            <a  href="<?php echo URL::to('/'); ?>"><img src="<?php echo URL::to('/'); ?>/public/img/header logo.png" height="120px" width="300px"></a>
        </div>
        <div class="navs-area">
                 @if(Auth::check())
                <ul class="logged">
                <li><a href="<?php echo URL::to('/') ?>"><strong>Instructions</strong></a></li>
                <!-- <li><a href=""><strong>Event</a></strong></li> -->
                <li class="last">
                ...
                @else
                <ul>
                <li><a href="<?php echo URL::to('/') ?>">Instructions</a></li>
